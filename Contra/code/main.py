    ...
    def setup(self):
        ...
        for obj in tmx_map.get_layer_by_name('Entities'):
            ...
            if obj.name == 'Enemy':
                Enemy(
                    ...
                    groups=(self.vulnerable_sprites, self.all_sprites),
                    shoot=self.shoot,
                    player=self.player,
                    collision_sprites=self.collision_sprites)
        ...
        for obj in tmx_map.get_layer_by_name('Platforms'):
            if obj.name == 'Platform':
                ...
                self.platform_border_rects.append(pygame.Rect(obj.x, obj.y, obj.width, obj.height))
    ...
    def platform_collisions(self):
        for platform in self.platform_sprites.sprites():
            for border in self.platform_border_rects:
                ...
                if border.colliderect(platform.rect):
